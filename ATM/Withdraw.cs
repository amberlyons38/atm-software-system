...
namespace ATM
{
    public partial class Withdraw : Form
    {
        ...
        public Withdraw(string accType, string acNum, string cn)
        {
            InitializeComponent();
            t = accType;
            Console.WriteLine(t);
        ...
        private void buttonenter_Click(object sender, EventArgs e)
        {
            ...
            if (balance - Convert.ToDouble(amount) < 5)
            {
                errorMessage.Text = "Withdrawal amount cannot leave balance at less than 5$";
                Console.WriteLine((errorMessage.Width / 2) - (this.Width / 2));
                errorMessage.Location = new Point(328, 205);
            ...
            {
                errorMessage.Text = "Maximum withdrawal amount is $3,000";
            ...
            {
                errorMessage.Text = "Minimum withdrawal amount is $5";
                Console.WriteLine((errorMessage.Width / 2) - (this.Width / 2));
            ...
            else
            {
                ...
                transaction.Withdrawal(Convert.ToDouble(amount));
        ...
        private void backbutton_Click(object sender, EventArgs e)
        {
            ...
            AccountSelectionScreen account = new AccountSelectionScreen(cardn, "withdraw");
            this.Close();
            account.Show();
        }
    }
